...
let yourSentence = "the \(nounArray[6]) is working on \(nounArray[1])"
...
let shoutString =  "HEY! " + didYouKnowString.capitalized
//: ### Exercise 3
//: How many characters are in this string? 
let howManyCharacters = "How much wood could a woodchuck chuck if a woodchuck could chuck wood?"
var charactreCount = 0
for c in howManyCharacters {
    if c != " " {
        charactreCount+=1
    }
}
print(charactreCount)
