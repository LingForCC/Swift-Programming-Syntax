...
let FoodDic = ["Anchovies": true, "Coconut": true, "Cilantro": false, "Liver": false]
...
var count = 0;
for key in studioAlbums.keys {
    if key.contains("Led Zeppelin") {
        count+=1
    }
}
print(count)
